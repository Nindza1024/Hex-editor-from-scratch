...
Проверим работу 16-ричного редактора целиком. Для этого создадим картинку, загрузим её в редактор, поменяем пиксели и сохраним новое изображение. Для начала в Paint создадим картинку для редактирования. Назовём её test2.png

![Картинка для редактирования](../Images_for_Learning_Articles/Images_5.png)

Далее загрузим эту картинку на полученный сайт и поменяем следующие байты:
- 115   1D -> 8D
- 116   DC -> DD
- 117   08 -> 48
- 118   B2 -> 92
...
- 136   8F -> D7
- 137   82 -> EF
Далее нажимаем кнопку сохранить и открываем полученный файл. 

![Картинка для редактирования](../Images_for_Learning_Articles/Images_6.png)

Как видно редактор полностью рабочий. 
